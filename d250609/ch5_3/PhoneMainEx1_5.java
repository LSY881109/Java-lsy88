...
public class PhoneMainEx1_5 {
    public static void main(String[] args) {
        ...
        IphoneEx1_4 iphoeEx1_4 = new IphoneEx1_4("애플", "아이폰 16", "약200만원", "서면롯데백화점");
        iphoeEx1_4.showInfo();
        ...
        if (phoneIphone instanceof IphoneEx1_4) {
            ...
            // 원래대로 본인의 형으로 변환함.
            IphoneEx1_4 iphoeEx1_42 = (IphoneEx1_4) phoneIphone;
            // 아이폰에 만 있는 기능.
        ...
        if (samsungPhone instanceof IphoneEx1_4) {
            // 다운 캐스팅 : 위 -> 아래 감. 부모 클래스에서 -> 자식 클래스 타입으로 변환.
            // 원래대로 본인의 형으로 변환함.
            IphoneEx1_4 iphoeEx1_42 = (IphoneEx1_4) samsungPhone;
            // 아이폰에 만 있는 기능.
            System.out.println("형이 아이폰 클래스 형이 맞다면, 여기에만 있는 기능 확인");
            iphoeEx1_42.sellInfo();

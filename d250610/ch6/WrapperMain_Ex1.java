...
public class WrapperMain_Ex1 {
    public static void main(String[] args) {
        ...
        // 자주 사용하는 옵션
        // 예시1, 문자열 -> wrapper 객체변환(Integer)
        Integer intObj1 = Integer.valueOf("123");
        // 기본형 -> 참조형 으로 변경을 왜 하나요?
        // 배열, 업그레이드 된 배열(컬렉션(리스트, 셋, 맵))등 사용시 해당요소를 클래스형으로
        // 담아야함, 왜냐하면, 컬렉션의 요소는 전부 타입으로 지정 해야함.
        // 자바 -> 코틀린 언어, 모든 타입이 객체임 (물론 파이썬)
        // 자바스크립트-> 리액트 문버 사용시, 타입 스크립트.

...
public class String_Ex1 {
    public static void main(String[] args) {
        ...
        // 자주 사용하는 문자열, 타입 : 기본형이 아님, 참조형 임!!!!!!
        // 문자열
        // 결론 : 도장을 찍어 내듯이 사용함.
        // 문자열을 변경할 때 새로운 메모리 값을 사용한다.
        // 그래서 메모리 낭비가 많다.

        // 대책, 이 문자열을 업그레이드해서, 매번 메모리를 새로 사용 안하고
        ...
        // 이번에는 업그레이드가 된 StringBuffer 클래스 활용
        // 똑같이 문자열 생성 후 연결
        ...
        System.out.println("업그레이가 된 StringBuffer 클래스 이용시 : 메모리 주소 확인 : " + System.identityHashCode(sb));

...
public class Member {
    ...
    // ============================================================================
    // 추가 사항 1
    // 회원 정보 내용을 csv 형식으로 문자열 반환 기능
    // 맴버 정보, 예) 김김김, 1234, lsy@naver.com, 2025-6-12 10시 10분
    public String toCSV() {
    ...
    // 매개변수의 정보 : 타입 문자열,
    // 내용 아래의 예) 의 형태입니다
    // 한줄의 멤버의 정보를 : 예) 김김김, 1234, lsy@naver.com, 2025-6-12 10시 10분
    //
    ...
    public static Member fromCSV(String csvLine) {
        ...
        String[] parts = csvLine.split(",", -1); // -1, 없는 데이터 있어도 그자리 형태를 유지, 정보 4개 형태
        // 시뮬레이션 2
        // parts = {"김김김","1234","lsy@naver.com","2025-6-12 10시 10분"}
        if (parts.length != 4) {
            return null;
        }

...
public class Exs_doc {
    // 퀴즈 .
    // 정적 메서드 만들기
    // 사용자 이름 입력 받고, 좋아하는 월을 입력 받고,
    // 예시 메서드, exmini_quiz1("홍길동, 5");
    // 좋아하는 월에 따른, 계절의 이름을 출력, 봄(3~5), 여름(6~8), 가을(9~11), 겨울(12~2)
    // 1)swutch 문 이용하거나, 2)if~ else if 문 이용해서 구현하기
    ...
    public static void exmini_quiz1(String name, int month) {
        ...
        System.out.println("[switch] " + name + "님이 좋아하는 " + month + "월은 " + season + "입니다.");
    }

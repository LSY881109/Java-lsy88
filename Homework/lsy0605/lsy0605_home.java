// 아래는 제공된 세 개의 Java 파일(`Car_model`, `Car`, `Car_main`)에 포함된 클래스와 메서드를 학습용으로
// 간단하고 보기 쉽게 요약한 설명입니다. `Homework.lsy0605.ch4` 패키지에 속한 이 코드는 자동차 관리 프로그램을 구현하며,
// 초보자 수준에서 이해하기 쉽게 CRUD(추가, 조회, 수정, 삭제), 검색, 더미 데이터 추가 기능을 제공합니다. 이전 `Member`
// 클래스와 유사한 구조를 재사용했습니다.
